...
public class loginpage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("E-email ID ");

        txtuseremail.setFont(new java.awt.Font("Segoe UI Semibold", 1, 24)); // NOI18N

        jLabel4.setFont(new java.awt.Font("Segoe UI Semibold", 1, 24)); // NOI18N
        jLabel4.setText("Password");

        txtuserpassword.setFont(new java.awt.Font("Segoe UI Semibold", 1, 24)); // NOI18N
        ...
        txtemailLayout.setHorizontalGroup(
            ...
            .addGroup(txtemailLayout.createSequentialGroup()
                ...
                .addGroup(txtemailLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtuseremail, javax.swing.GroupLayout.DEFAULT_SIZE, 203, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       /* String name=txtuseremail.getText();
        ...
        try {
            ...
            String query = "select * from singup WHERE username='" + name + "' AND password='" + pass + "'";
            ResultSet rs = st.executeQuery(query);
            if (rs.next()) {
                dispose();
                //lbl.setText("Your login successfully");
                JOptionPane.showMessageDialog(null,"Successfully Login");
            } else {
                JOptionPane.showMessageDialog(null,"Wrong Entry");
                // lbl.setText("Your login Unsuccessfully");
                // rej.setVisible(true);
            }
