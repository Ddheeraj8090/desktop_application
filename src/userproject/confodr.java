 ...
 */
public class confodr extends javax.swing.JFrame {

    /**
     * Creates new form confodr
     */
    public confodr() {
        initComponents();
        carttoedite();
    ...
    private void initComponents() {
        ...
        tbltable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PNO.", "NAME", "MOBILE NO.", "STATE", "CITY", "ADDRESS", "PIN CODE", "TOTAL AMOUNT", "PAYMENT TYPE"
            }
        ));
        ...
        jPanel3.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, 910, 410));

        lblresult.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jPanel3.add(lblresult, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 470, 420, 30));
        jPanel3.add(txtco, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 470, 270, 30));
        ...
        jPanel3.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 510, 130, 30));

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel12.setText("Cancel Order Enter Order ID ");
        jPanel3.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 430, 420, 30));
...
/*cancel btn */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(confodr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        Connection con=null;
         ...
         String url = "jdbc:mysql://localhost:3306/project";
                    ...
                    String q = "select * from ordd";
                    ResultSet rs = st.executeQuery(q);
                    DefaultTableModel bleModel    = (DefaultTableModel)tbltable.getModel();
                   bleModel.removeRow(0);
        
                    while(rs.next()){
                        
                        String arr[]={String.valueOf(rs.getInt("ono")),String.valueOf(rs.getString("name")),String.valueOf(rs.getString("mobileno")),String.valueOf(rs.getString("state")),String.valueOf(rs.getString("city")),String.valueOf(rs.getString("address")),String.valueOf(rs.getInt("pincode")),String.valueOf(rs.getInt("totalpayment"))};
                        bleModel.addRow(arr);
                    }
        ...
        try {
            ...
            String pdelete= txtco.getText();
            
            if(pdelete.isEmpty()){
                lblresult.setText("Enter Product ON. ");
            }
            else{
            String url = "jdbc:mysql://localhost:3306/project";
            ...
            String q = "delete from ordd where ono='" + pdelete + "'";
           boolean b = stat.execute(q);
           
          lblresult.setText("Your Order Cancel successfully ");
